...
function startApp(): void {
	...
	if (SCALE_MODE === 'USER_SCALE') {
		const screenMetrics: Utils.ScreenMetrics = Utils.ScreenUtils.calculateScreenMetrics(gameWidth, gameHeight, MAX_GAME_WIDTH,
			MAX_GAME_HEIGHT);
...
window.onload = () => {
	...
	if (webFontLoaderOptions === null) {
		...
		// Load the fonts defined in webFontsToLoad from Google Web Fonts, and/or any Local Fonts then start the game knowing the fonts
		// are available
