...
module.exports = {
    ...
    plugins: [
        ...
        new webpack.DefinePlugin({
            ...
            'SOUND_EXTENSIONS_PREFERENCE': JSON.stringify([ // Re-order the items in this array to change the desired
                // order of checking your audio sources (do not add/remove/modify the entries themselves)
